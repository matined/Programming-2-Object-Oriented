...
int main() {
    ...
    if (d5.ifEqual(d6))
        cout << "Dates: " << d5 << " and " << d6 << " are equal " << endl;
    else
    ...
    d5.SetFormat() = true;
    d6.SetFormat() = true;
    cout << "Days from: " << d5 << " to " << d6 << " : " << CountDays(d5, d6)
         << endl;

    d5.SetFormat() = false;
    d6.SetFormat() = false;
    cout << "Days from: " << d6 << " to " << d5 << " : " << CountDays(d6, d5)
         << endl;
    cout << "Days from: " << d5 << " to " << d5 << " : " << CountDays(d5, d5)
         << endl;
}